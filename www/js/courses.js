...
const COURSES = [
  ...
  { id: "c15", order: 15, free: true, drillCount: 24, titleKey: "c15.title", subKey: "c15.sub", concepts: ["facing_raise"] },
  { id: "c16", order: 16, free: true, drillCount: 24, titleKey: "c16.title", subKey: "c16.sub", concepts: ["3bet_pot", "spr"] },
  { id: "c17", order: 17, free: true, drillCount: 24, titleKey: "c17.title", subKey: "c17.sub", concepts: ["pot_control"] },
  { id: "c18", order: 18, free: true, drillCount: 24, titleKey: "c18.title", subKey: "c18.sub", concepts: ["turn_defense"] },
  { id: "c19", order: 19, free: true, drillCount: 24, titleKey: "c19.title", subKey: "c19.sub", concepts: ["float", "delayed"] },
  { id: "c20", order: 20, free: true, drillCount: 24, titleKey: "c20.title", subKey: "c20.sub", concepts: ["overbet"] },
  { id: "c21", order: 21, free: true, drillCount: 24, titleKey: "c21.title", subKey: "c21.sub", concepts: ["donk"] },
  { id: "c22", order: 22, free: true, drillCount: 24, titleKey: "c22.title", subKey: "c22.sub", concepts: ["thin_value"] },
  { id: "c23", order: 23, free: true, drillCount: 24, titleKey: "c23.title", subKey: "c23.sub", concepts: ["semi_bluff", "draws"] },
  { id: "c24", order: 24, free: true, drillCount: 24, titleKey: "c24.title", subKey: "c24.sub", concepts: ["river_defense"] },
  { id: "c25", order: 25, free: true, drillCount: 24, titleKey: "c25.title", subKey: "c25.sub", concepts: ["multiway"] },
  { id: "c26", order: 26, free: true, drillCount: 24, titleKey: "c26.title", subKey: "c26.sub", concepts: ["exploit"] },
  { id: "c27", order: 27, free: true, drillCount: 24, titleKey: "c27.title", subKey: "c27.sub", concepts: ["tournament", "icm"] },
  { id: "c28", order: 28, free: true, drillCount: 24, titleKey: "c28.title", subKey: "c28.sub", concepts: ["line_plan"] },
  { id: "c29", order: 29, free: true, drillCount: 24, titleKey: "c29.title", subKey: "c29.sub", concepts: ["special_board"] },
  { id: "c30", order: 30, free: true, drillCount: 24, titleKey: "c30.title", subKey: "c30.sub", concepts: ["capstone"] },
];
